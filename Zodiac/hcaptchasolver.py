...
class bypasscaptcha():
    ...
    def hcaptcha(self):
        ...
        if self.CAPTCHASERVICE in servicelist:
            ...
            import essentials.captcha.captchaai_io as capsolver
            CAPTCHASOLUTION = asyncio.run(capsolver.Solver.solution())
            
            # from essentials.captcha.captchaai_io import solution as CAPTCHASOLUTION
            return CAPTCHASOLUTION
        
        elif self.CAPTCHASERVICE == 5 or self.CAPTCHASERVICE == "nocaptchaai.com":
            import essentials.captcha.nocaptchaai_com as capsolver
            
            CAPTCHASOLUTION = asyncio.run(capsolver.Solver.solution())
            return CAPTCHASOLUTION
        
        elif self.CAPTCHASERVICE == 6 or self.CAPTCHASERVICE == "aio-hcaptcha":
            import essentials.captcha.aiohcaptcha as capsolver
