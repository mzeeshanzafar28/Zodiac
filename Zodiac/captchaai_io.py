...
# from essentials.filesupport.proxy import loadproxyclass
    ...
    async def solution():
        ...
        if response["status"] == "ready":
            ...
            if response["errorDescription"] == "Captcha not recognized":
                pystyle.Write.Print(f"\t-> Captcha was not recognized, trying again now ...\n", pystyle.Colors.red, interval=0)
